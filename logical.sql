...
Ans....
==========
1. db.emp.find({ $and: [{ job: "clerk" }, { sal: { $lt: 1500 } }] })
   
2. db.emp.find({ $and: [{ job: "manager" }, { deptno: 30 }] }, { ename: 1, hiredate: 1, _id: 0 })
   
3. db.emp.find({ $or: [{ deptno: 30 }, { job: "analyst" }] })
   
4. db.emp.find({ $and: [{ sal: { $lt: 1100 } }, { job: "clerk" }] })
   
5. db.emp.find({ $and: [{ job: "salesman" }, { deptno: { $in: [20, 30] } }] }, { empno: 1, ename: 1, _id: 0 })
   
6. db.emp.find({ $and: [{ job: "president" }, { sal: 4000 }] }, { ename: 1, sal: 1, _id: 0 })
   
7. db.emp.find({ empno: { $in: [7902, 7839, 7698] } })
   
8. db.emp.find({ $and: [{ hiredate: { $gt: new Date("1981-12-31") } }, { hiredate: { $lt: new Date("1985-01-01") } }] }, { ename: 1, _id: 0 })
   
9. db.emp.find({ job: { $in: ["manager", "salesman", "clerk"] } }, { ename: 1, job: 1, _id: 0 })

10. db.emp.find({ $and: [{ hiredate: { $gt: new Date("1981-12-31") } }, { deptno: { $in: [10, 30] } }] }, { ename: 1, sal: 1, hiredate: 1, _id: 0 })
